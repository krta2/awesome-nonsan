...
- 우표
  ...
  - 규격봉투를 사용할 경우 (훈련소에서 나눠주는 봉투) 는 330원 짜리도 가능하지만 비규격봉투의 경우 420원짜리를 사용해야 받을 수 있다. 아니면 반송되니 주의할 것
- 약
...
- 화생방
  - 방독면을 믿지 마라, 그거 어짜피 만들어진지 30년 지나서 효과가 없을 것이다
  - 숨 참고 들어갔다가 1분 40초 정도 지나면 내보내 주니 참는 연습을 미리 해가자
  - 정화통을 떨어트리는 순간 모든이의 고통이 시작된다
