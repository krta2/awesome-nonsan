...
- 우표
  ...
  - 규격봉투(훈련소에서 나눠주는 봉투)를 사용할 경우는 330원 짜리도 가능하지만 비규격봉투의 경우 420원짜리를 사용해야 받을 수 있다. 아니면 반송되니 주의할 것
- 약
...
- 마스크
  ...
  - 황사 마스크라고 해서 미세먼지 마스크 (KF84) 나눠줌, 대신 갯수가 제한이 있어 재활용 해야 함
- 편지지, 편지봉투
...
- 화생방
  - 방독면의 상태에 따라 정화통까지 제대로 장착해도 CS 가스가 들어올 수 있음. 가스실에 들어가기 전에 정화통을 포함한 방독면 상태를 확실히 체크하자(정화통을 손바닥으로 막았을 때 들숨이 아예 안 쉬어져야함)
  - 숨 참고 들어갔다가 1분 40초 정도 지나면 내보내 주니 참는 연습을 미리 해가자
